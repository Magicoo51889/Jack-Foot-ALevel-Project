...
{% tabs %}
{% tab title="First Tab" %}
<pre class="language-javascript"><code class="lang-javascript"><strong>create() {
...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>The player being able to move side to side</p></figcaption></figure>
